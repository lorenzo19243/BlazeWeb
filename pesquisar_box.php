...
$busca = "SELECT * FROM tvbox_chamados WHERE nome LIKE '%$pesquisar%' OR bairro LIKE '%$pesquisar%'  OR rua LIKE '%$pesquisar%'";
...
if ($observacao >= '0')
{
$x = "<button type='button' class='position-absolute top-0 start-100 translate-middle badge rounded-pill btn-warning' data-toggle='modal' data-target='#modal$id_tvbox'>
OBS!
</button>";
}
else
...
if (empty($consulta)) { //Se nao achar nada, lança essa mensagem
 ...
 ?>
        ...
        <p class="mt-1 mb-1 text-muted"><a class="btn btn-secondary position-relative" href="relatorio_box.php"> RELATORIO </a></p>
      </div>
      <div class="col"> </div>
    </div>
  </div>
