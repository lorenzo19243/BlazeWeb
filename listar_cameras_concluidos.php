    ...
    if($r >= null){ 
        ...
        while($reg = mysqli_fetch_assoc($r)){
			...
			echo '<tr class="bg-danger text text-white" style="border:none">
				...
				$clientes = mysqli_query($conn,'SELECT * FROM cameras WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);
...
*ORDEM DE SERVIÇO Nº '.$cliente['id_cameras'].' CONCLUIDA*
...
*TEMPO DO CHAMADO:* '.$cliente['tempo'].'
