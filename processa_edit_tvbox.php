...
$altera_cliente = "UPDATE tvbox_chamados SET tecnico='$tecnico', veiculo='$veiculo', alterado_por='$alterado_por', ultima_alteracao='$ultima_alteracao', status='$status', concluido='$concluido', conclusao='$conclusao', data_fim='$data_fim', tempo='$tempo' WHERE id_tvbox='$id_tvbox'";
