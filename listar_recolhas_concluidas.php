...
<div class="container-fluid">
    <div class="row">
        ...
        <a class="btn btn-dark position-relative"  href="listar_recolhas.php">
...
<a class="btn btn-dark position-relative"  href="listar_recolhas_concluidas.php">
...
<button type="button" class="btn btn-dark position-relative" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">NOVA RECOLHA <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
  <path d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5"/>
  <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5z"/>
</svg></button>
        </div>
        <div class="col-md-4 bg-warning  justify-content-between p-3">        <form class="row g-5" method="POST" action="pesquisar_recolhas.php">
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="col-md-auto" style="text-align:center">
            <?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE  concluido="SIM" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);

printf("<small class='text-muted'>CONCLUIMOS <strong>%d</strong> RECOLHAS</small>", $row_cnt); ?>
          </div>
        </div>
        <div class="col"></div>
      </div>
    ...
    if($r >= null){ 
        ...
        while($reg = mysqli_fetch_assoc($r)){
			...
			echo '<tr class="bg-danger text text-white" style="border:none">
				...
				$clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY nome DESC;');        $row_cnt = mysqli_num_rows($clientes);

printf(" - %d RECOLHAS CONCLUIDAS.</strong>\n", $row_cnt);
  			
            $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY ultima_alteracao  DESC;');
            if($clientes != null){
                echo '</td>
                <td style="border:none"></td>
                <td style="border:none"></td>
...
<td style="border:none"></td>
	...
	<td>'.date('d/m/Y - H:i:s', strtotime($cliente['ultima_alteracao'])).'</td>
	<td><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" data-whatever="'.$cliente['id_cliente'].'" 
	data-whatevernome="'.$cliente['nome'].'" 
 data-whateverconclusao="'.$cliente['conclusao'].'" 
 data-whateverstatus=""    
  data-whateverbairro="'.$cliente['bairro'].'"   
   data-whateverrua="'.$cliente['rua'].'"   
    data-whatevernumero="'.$cliente['numero'].'"
    data-whatevertecnico="'.$cliente['tecnico'].'"   
     data-whateverveiculo="'.$cliente['veiculo'].'"      data-whateverplano="'.$cliente['plano'].'"                 
       data-whateveroperador="'.$cliente['criado_por'].'" 
       data-whateversituacao="RECOLHER EQUIPAMENTOS" data-whateverdata-cadastro="'.$cliente['data_cadastro'].'"                     data-whateveralterado_por="'.$cliente['alterado_por'].'" 
       data-whateverultima_alteracao="'.$cliente['ultima_alteracao'].'">
  ...
  <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
                     ...
                     <a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="'.$cliente['id_cliente'].'" 
data-whatevernome="'.$cliente['nome'].'"
data-whateverconclusao="'.$cliente['conclusao'].'"
data-whateveroperador="'.$cliente['criado_por'].'" 
data-whateverstatus="" 
...
data-whateverultima_alteracao="'.$cliente['ultima_alteracao'].'"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
</svg></a>
</td>	
	<td><button type="button" class="btn btn-primary btn-sm" data-clipboard-text="
*ORDEM DE SERVIÇO Nº '.$cliente['id_cliente'].'*
`RECOLHA CONCLUIDA`
...
*EQUIPAMENTOS RECOLHIDOS COM SUCESSO✅*">BAIXA</button></td>
...
<div class="modal fade" id="cadCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header ">
        <h5 class="modal-title" id="exampleModalLabel">CADASTRAR RECOLHA</h5>
