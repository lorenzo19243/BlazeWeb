...
$busca = "SELECT * FROM clientes WHERE nome LIKE '%$pesquisar%' OR bairro LIKE '%$pesquisar%'  OR rua LIKE '%$pesquisar%'";
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="col-md-auto" style="text-align:center">
            <?php $clientes = mysqli_query($conn,'SELECT * FROM clientes ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);
...
echo '    <table class="table table-striped table-sm" style="font-size: 14px;">
    <thead class="table-dark">
      <tr>
        ...
        <th scope="col" style="border:none" width="12%">SITUAÇÃO </th>
        <th scope="col" style="border:none">P/ DIA </th>
...
if ($urgente >= 'SIM')
{
$x = "style='background-color: lightcoral;'";
}
else
{
$x = "";
...
if ($observacao >= '0') {
    $os = "<button type='button' class='translate-middle badge rounded-pill btn-warning' data-toggle='modal' data-target='#modal$id_cliente'>
OBS!
</button>";
} else {
    $os = "";
...
?>
</td>   <td><button type="button" class="btn btn-secondary btn-sm"><?php echo date('d/m/Y',  strtotime($agendado));?></button></td>
...
if ($conclusao >= '0')
{
$x = "<button class=\"translate-middle close\"  data-toggle='modal' data-target='#modala$id_cliente'><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"24\" height=\"24\"> <path d=\"M1.75 4.5a.25.25 0 0 0-.25.25v.852l10.36 7a.25.25 0 0 0 .28 0l5.69-3.845A.75.75 0 0 1 18.67 10l-5.69 3.845c-.592.4-1.368.4-1.96 0L1.5 7.412V19.25c0 .138.112.25.25.25h20.5a.25.25 0 0 0 .25-.25v-8.5a.75.75 0 0 1 1.5 0v8.5A1.75 1.75 0 0 1 22.25 21H1.75A1.75 1.75 0 0 1 0 19.25V4.75C0 3.784.784 3 1.75 3h15.5a.75.75 0 0 1 0 1.5H1.75Z\"></path><path d=\"M24 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z\"></path></svg></button>";
}
else
{
$x = "";
...
?>
        ...
        <td class="text text-center"><?php echo $veiculo; ?></td>
  ...
  data-whateverbairro="<?php echo $linha['bairro']; ?>"   
   data-whateverrua="<?php echo $linha['rua']; ?>"   
    ...
    data-whateverconclusao="<?php echo $linha['conclusao']; ?>"  
     data-whateversinal="<?php echo $linha['sinal']; ?>"      data-whateverplano="<?php echo $linha['plano']; ?>"                 
       ...
       data-whateverultima_alteracao="<?php echo $ultima_alteracao = date('d/m/Y H:i:s',  strtotime($ultima_alteracao));?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
...
*TIPO CHAMADO:* <?php echo $situacao ?>ㅤ   
...
<div class="modal fade" id="cadCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header ">
        <h5 class="modal-title" id="exampleModalLabel">AGENDAR REPARO!</h5>
      ...
      <form>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="veiculo" id="recipient-sinal" maxlength="50" class="form-control -10" disabled>
          </div>
        </div>
        <div class="row">
