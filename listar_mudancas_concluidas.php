    ...
    if($r >= null){ 
        ...
        while($reg = mysqli_fetch_assoc($r)){
			...
			echo '<tr class="bg-danger text text-white" style="border:none">
				...
				$clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY nome DESC;');
...
<td><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" data-whatever="'.$cliente['id_cliente'].'" 
 ...
 data-whateverconclusao=""    
  data-whateverbairro="'.$cliente['bairro2'].'"   
   data-whateverrua="'.$cliente['rua2'].'"   
    data-whatevernumero="'.$cliente['numero2'].'"
