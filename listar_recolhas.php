...
seguranca_adm();
$consulta = 'SELECT * FROM recolhas WHERE  STATUS="<button type=\'button\' class=\'btn btn-primary btn-sm\'> andamento</button>"  
union 
(SELECT * FROM recolhas WHERE  STATUS="<button type=\'button\' class=\'btn btn-danger btn-sm\' >remarcar</button>" )
union 
(SELECT * FROM recolhas WHERE  STATUS="<button type=\'button\' class=\'btn btn-warning btn-sm\' >falta_drop</button>" )
union
...
<div class="container-fluid">
    <div class="row">
        ...
        <a class="btn btn-dark position-relative"  href="recolhas">
...
<a class="btn btn-dark position-relative"  href="recolhas_concluidas">
    ...
    ?>
             ...
             <tr>
                ...
                <td ><span style="font-weight: bold;"><?php echo $nome ?> </span><br>BAIRRO - <?php echo $bairro ?></td>
                  <td><?php echo $rua = mb_strtoupper($rua); ?>, Nº <?php echo $numero ?> - <?php echo $bairro ?> </br><?php
...
?>
                ...
                <td class="text text-center">
                    ...
                    <a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" data-whatever="<?php echo $linha['id_cliente']; ?>" data-whatevernome="<?php echo $linha['nome']; ?>" 
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
  ...
  <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
                ...
                <td class="text text-center">
                    <a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="<?php echo $linha['id_cliente']; ?>" 
...
<?php 
                    ...
                    ?>
<td class="text text-center">
                    <a href="processa_excluir_recolhas.php?id_cliente=<?php echo $linha['id_cliente']; ?>" onClick="return confirm('Deseja realmente deletar o cliente?')">
...
*TIPO CHAMADO:* RECOLHER TODOS OS EQUIPAMENTOS     
            ...
            <input type="text" name="tempo" id="recipient-tempo" maxlength="50" class="form-control">
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <select class="form-control form-select-lg mb-2 select2" name="status" id="status" aria-label=".form-select-lg example">
                                ...
                                <option value="<button type='button' class='btn btn-warning btn-sm' >falta_drop</button>">FALTA O DROP</option>
...
(function() {
  // Get the modal
  setTimeout(function(){
    const modal = document.getElementById("mymodalpopup");
...
<div id="mymodalpopup" class="modalpopup">
  <!-- Modal content -->
  <div class="modal-contentmodalpopup">
 ...
 <thead class="bg-dark text text-white">
  <tr>
    <td></td>
    <td>Ei! temos recolhas para hoje, bora cuidar?</td>
    <td></td>
  </tr>
    </thead>  
<tbody> 
...
?>  <?php 
  ...
  <tr>
    <td><?php echo $nome?></td>
    <td>PLANO: <?php echo $plano?></td>
    <td><?php echo date('d/m/Y',  strtotime($agendado));?></td>
  </tr> <?php } ?>
 ...
 <thead class="bg-dark text text-white">
  <tr>
    <td></td>
    <td>TEMOS <?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE  STATUS="A LANÇAR" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);

printf("%d", $row_cnt); ?> EM ATRASO PARA LANÇAR!</td>
    <td></td>
  </tr>
    </thead>  
</table>
