...
seguranca_adm();
$consulta = "SELECT * FROM clientes WHERE concluido = 'SIM' ORDER BY ultima_alteracao DESC ; ";
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 bg-warning justify-content-between p-3"><a class="btn btn-dark position-relative"  href="listar_chamados.php">CHAMADOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
</svg></a> <a class="btn btn-dark position-relative"  href="listar_chamados_concluidos.php">CONCLUIDOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
...
<thead class="bg-dark text text-white">
  <tr>
    ...
    <th scope="col" style="border:none">FINALIZADO POR</th>
    ...
    if($r >= null){ 
        ...
        while($reg = mysqli_fetch_assoc($r)){
			...
			echo '<tr class="bg-danger text text-white" style="border:none">
				...
				$clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);

printf(" - %d REPAROS CONCLUIDOS.</strong>\n", $row_cnt);
  			
            $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY ultima_alteracao DESC;');
...
$interval = $data1->diff($data2);
            ...
            <td>'.$cliente['situacao'].'</td>
                   <td>'.$cliente['alterado_por'].'</td>
                <td>'.$cliente['status'].'</td>
				 <td>'.$cliente['tecnico'].'</td>
	<td>'.$cliente['veiculo'].'</td>
	<td>'.date('d/m/Y - H:i:s', strtotime($cliente['ultima_alteracao'])).'</td><td><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" 
data-whatever="'.$cliente['id_cliente'].'" 
data-whatevernome="'.$cliente['nome'].'" 
data-whatevertecnico="'.$cliente['tecnico'].'" 
data-whateverveiculo="'.$cliente['veiculo'].'"    
data-whateverpppoe="'.$cliente['pppoe'].'"   
data-whateverrede="'.$cliente['rede'].'"   
data-whateverredesenha="'.$cliente['redesenha'].'"
data-whateverobservacao="'.$cliente['observacao'].'"  
data-whateverconclusao="'.$cliente['conclusao'].'"  
data-whatevernovo_sinal="'.$cliente['novo_sinal'].'"      
data-whateverremoto="'.$cliente['remoto'].'"  
data-whateverrepetidor="'.$cliente['repetidor'].'" 
data-whatevertempo="'.$cliente['tempo'].'" 
data-whateveroperador="'.$cliente['criado_por'].'" 
data-whateversituacao="'.$cliente['situacao'].'" 
data-whateverdata-cadastro="'.$cliente['data_cadastro'].'"
data-whateveralterado_por="'.$cliente['alterado_por'].'" 
data-whateverultima_alteracao="'.$ultima_alteracao = date('d/m/Y H:i:s',  strtotime($ultima_alteracao)).'"> 
...
<td class="text text-center"><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="'.$cliente['id_cliente'].'" 
data-whatevernome="'.$cliente['nome'].'"
data-whateveroperador="'.$cliente['criado_por'].'" 
data-whateverveiculo="'.$cliente['veiculo'].'"
data-whateverconclusao="'.$cliente['conclusao'].'"  
data-whateversinal="'.$cliente['sinal'].'" 
data-whatevertecnico="'.$cliente['tecnico'].'" 
data-whateverplano="'.$cliente['plano'].'" 
data-whateverrede="'.$cliente['rede'].'" 
data-whateverredesenha="'.$cliente['redesenha'].'" 
data-whateverdata-cadastro="'.$cliente['data_cadastro'].'" 
data-whatevertempo="'.$interval->format('%H:%I').'"
data-whateveralterado_por="'.$cliente['alterado_por'].'" 
data-whateverultima_alteracao="'.$ultima_alteracao = date('d/m/Y H:i:s',  strtotime($ultima_alteracao)).'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
</svg></a></td>

<td class="text text-center">
                    <a href="processa_excluir_clientes.php?id_cliente='.$cliente['id_cliente'].'" onClick="return confirm("Deseja realmente deletar o cliente?")"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
...
*ORDEM DE SERVIÇO Nº '.$cliente['id_cliente'].' CONCLUIDA*
...
*SINAL IXC:* '.$cliente['novo_sinal'].'

*SITUAÇÃO:* '.$conclusao = mb_strtoupper($conclusao).' 
...
<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form method="POST" action="processa_edit_clientes_concluidos.php" enctype="multipart/form-data">
        <div class="row">
...
<option value="YAN">YAN</option>
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-12">
            ...
            <select class="form-control form-select-lg mb-1 select2" name="urgente" id="urgente" aria-label=".form-select-lg example">
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <input type="text" name="novo_sinal" id="recipient-sinal" maxlength="50" class="form-control">
          </div>
            <div class="col-md-3 col-sm-12">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <select class="form-control form-select-lg mb-1 select2" name="repetidor" id="repetidor" aria-label=".form-select-lg example">
              <option value="NAO">NAO</option>
              <option value="SIM">SIM</option>
            </select>
          </div>
