...
$busca = "SELECT * FROM instalacoes WHERE nome LIKE '%$pesquisar%' OR bairro LIKE '%$pesquisar%'  OR rua LIKE '%$pesquisar%'";
...
<a class="btn btn-dark position-relative"  href="listar_instalacoes.php">INSTALACOES <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
</svg></a> 
<a class="btn btn-dark position-relative"  href="listar_instalacoes_concluidas.php">CONCLUIDAS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
  <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/>
  <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
</svg></a>
<button type="button" class="btn btn-dark position-relative" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">NOVA INSTALAÇÃO <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="col-md-auto" style="text-align:center">
            <?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE  concluido="SIM" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);

printf("<small class='text-muted'>CONCLUIMOS <strong>%d</strong> INSTALAÇÕES</small>", $row_cnt); ?>
          </div>
        </div>
        <div class="col"></div>
      </div>
...
{
echo '  <table class="table" style="font-size: 12px; border:none">
    <thead class="bg-dark text text-white " >
     <tr >
        <th scope="col" style="border:none"> OS.</th>
        <th scope="col" style="border:none" width="28%">CLIENTE</th>
...
$interval = $data1->diff($data2);
    ...
    ?>
      ...
      <tr>
        ...
        <td><span style="font-weight: bold;"><?php echo $nome = mb_strtoupper($nome); ?> </span><br> CPF: <?php echo $cpf ?> - <a class=" start-100 translate-middle badge rounded-pill btn-primary "  href="imprimir_contrato.php?id_cliente=<?php echo $linha['id_cliente']; ?> " target="_blank">CONTRATO</a></td>
        <td><?php echo $rua ?>, Nº <?php echo $numero ?> - <?php echo $bairro ?>
          <?php
...
if ($observacao >= '0')
{
$x = "<button type='button' class='translate-middle badge rounded-pill btn-warning' data-toggle='modal' data-target='#modal$id_cliente'>
OBS!
</button>";
}
else
   ...
   data-whateverrua="<?php echo $linha['rua']; ?>"   
    ...
    data-whatevertecnico="<?php echo $linha['tecnico']; ?>"   
     data-whateverveiculo="<?php echo $linha['veiculo']; ?>"      data-whateverplano="<?php echo $linha['plano']; ?>"                 
       ...
       data-whateverultima_alteracao="<?php echo $ultima_alteracao; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
  <path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5z"/>
  <path d="M3 2.5a.5.5 0 0 1 .5-.5H4a.5.5 0 0 0 0-1h-.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1H12a.5.5 0 0 0 0 1h.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5z"/>
  <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
</svg> </a>
       </td>
        <td class="text text-center"><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="<?php echo $linha['id_cliente']; ?>" 
...
<td class="text text-center">
                    <a href="processa_excluir_instalacoes.php?id_cliente=<?php echo $linha['id_cliente']; ?>" onClick="return confirm('Deseja realmente deletar o cliente?')">
...
*TIPO CHAMADO:* INSTALAÇÃO FIBRA OPTICA   
      ...
      <form>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" id="recipient-observacao" disabled>
          </div>
            <div class="col-md-12 col-sm-12">
            <label for="recipient-conclusao" class="col-form-label">CONCLUSAO</label>
            <input type="text" class="form-control" id="recipient-conclusao" disabled>
          </div>
        </div>
        <div class="row">
          <div class="col-md-5 col-sm-12">
...
<option value="YAN">YAN</option>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12">
            ...
            <select class="form-control form-select-lg mb-1 select2" name="status" id="status" aria-label=".form-select-lg example">
              ...
              <option value="<button type='button' class='btn btn-warning btn-sm' >desistiu</button>">DESISTIU</option>
            </select>
          </div>
        </div>
        <div class="row">
