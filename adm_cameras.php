...
<div class="container-fluid">
  ...
  <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466"/>
    ...
    <a class="btn btn-sm btn-dark "  href="listar_cameras.php">CHAMADOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
</svg></a> 
    <a class="btn btn-sm btn-dark "  href="listar_cameras_concluidos.php">CONCLUIDOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
  <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/>
  <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
</svg></a>
      <button type="button" class="btn btn-sm btn-dark " data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">NOVO CHAMADO <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
  ...
  <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5z"/>
    ...
    <div class="col-md-4 bg-warning justify-content-between p-3 d-flex">
      <form class="row g-5" method="POST" action="pesquisar_cameras.php">
        <div class="col-auto">
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="col-md-auto" style="text-align:center">
            <?php $clientes = mysqli_query($conn,'SELECT * FROM cameras WHERE  concluido="SIM" ORDER BY nome DESC;');
				$row_cnt = mysqli_num_rows($clientes);
...
if ($observacao >= 0)
{
$x = "<button type='button' class='position-absolute top-0 start-100 translate-middle badge rounded-pill btn-warning' data-toggle='modal' data-target='#modal$id_cameras'>
OBS!
</button>";
}
else
...
echo $x;
?>    
          </td>  <td><?php echo date('d/m/Y',  strtotime($agendado));?></td>
...
?></td>
        ...
        <td class="text text-center"><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" data-whatever="<?php echo $linha['id_cameras']; ?>" data-whatevernome="<?php echo $linha['nome']; ?>" 
 ...
 data-whateverstatus=""    
  ...
  <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
        ...
        <td class="text text-center"><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="<?php echo $linha['id_cameras']; ?>" 
...
<td class="text text-center">
                    <a href="processa_excluir_cameras.php?id_cameras=<?php echo $linha['id_cameras']; ?>" onClick="return confirm('Deseja realmente deletar o cliente?')">
...
if (empty($consulta)) { //Se nao achar nada, lança essa mensagem
 ...
 ?>
        ...
        <p class="mt-1 mb-1 text-muted"><a class="btn btn-secondary position-relative" href="relatorio_cameras.php"> RELATORIO </a></p>
      </div>
      <div class="col"> </div>
    </div>
  </div>
      ...
      <form method="POST" action="processa_edit_cameras.php" enctype="multipart/form-data">
        <div class="row">
          ...
          <div class="col-md-2 col-sm-12">
            ...
            <select class="form-control form-select-lg mb-2 select2" name="veiculo" id="veiculo" aria-label=".form-select-lg example">
...
function processa_cam() {
    ...
    xhttp.open("GET", "processa_cameras.php?logins="+logins+"&cliente="+cliente);
    xhttp.send();    
}      
</script>
