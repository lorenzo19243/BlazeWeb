...
?>
    <a class="nav-link" id="pills-geral-tab" data-toggle="pill" href="#pills-geral" role="tab" aria-controls="pills-geral" aria-selected="false">TOTAL GERAL</a>
  </li>
</ul>
...
<div class="card-deck">
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?> </h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
...
echo $data['total']; ?></h1>
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">...</div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">...</div>
  <div class="tab-pane fade" id="pills-setembro" role="tabpanel" aria-labelledby="pills-setembro-tab">
  
  
 <div class="card-deck">
  <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
  <div class="card-header">REPAROS EM SETEMBRO</div>
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?> </h1>
  ...
  <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
  <div class="card-header">INSTAL. EM SETEMBRO</div>
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
  <div class="card-header">MUDANÇAS EM SETEMBRO</div>
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
   ...
   <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
  <div class="card-header">RECOLHAS EM SETEMBRO</div>
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ...
 <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">TOTAL DE CHAMADOS</div>
  <div class="card-body">
    <h1 class="card-title"><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="09" AND concluido="SIM") +
...
echo $data['total']; ?></h1>
 ...
 <div class="card-deck">
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?> </h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ...
 <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">TOTAL DE CHAMADOS</div>
  <div class="card-body">
    <h1 class="card-title"><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="10" AND concluido="SIM") +
...
echo $data['total']; ?></h1>
 ...
 <div class="card-deck">
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?> </h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ...
 <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">TOTAL DE CHAMADOS</div>
  <div class="card-body">
    <h1 class="card-title"><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="11" AND concluido="SIM") +
...
echo $data['total']; ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?> </h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ...
 <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">TOTAL DE CHAMADOS</div>
  <div class="card-body">
    <h1 class="card-title"><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="12" AND concluido="SIM") +
...
echo $data['total']; ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf(" %d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf(" %d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf(" %d", $row_cnt);				
 ?></h1>
  ...
  <div class="card-body">
    <h1 class="card-title"><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf(" %d", $row_cnt);				
 ...
 <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">TOTAL DE CHAMADOS</div>
  <div class="card-body">
    <h1 class="card-title"><?php $result=mysqli_query($conn, "SELECT (SELECT COUNT(*) FROM clientes WHERE concluido = 'SIM') +
