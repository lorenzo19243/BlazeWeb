...
$altera_cliente = "UPDATE clientes SET tecnico='$tecnico', veiculo='$veiculo', alterado_por='$alterado_por', ultima_alteracao='$ultima_alteracao', status='$status', novo_sinal='$novo_sinal', conclusao='$conclusao', concluido='$concluido', remoto='$remoto', repetidor='$repetidor', rede='$rede', redesenha='$redesenha', data_fim='$data_fim', tempo='$tempo', urgente='$urgente' WHERE id_cliente='$id_cliente'";
...
if($resposta){
    ...
    $_SESSION['success'] = "
    <div class='alert alert-success alert-dismissible fade show text text-center mb-0' role='alert'>
                                
                                <strong> STATUS ALTERADO COM SUCESSO &nbsp;  <svg class=\"bi flex-shrink-0 me-2\" width=\"24\" height=\"24\" role=\"img\" aria-label=\"Success:\"><use xlink:href=\"#check-circle-fill\"/></svg></strong> 
