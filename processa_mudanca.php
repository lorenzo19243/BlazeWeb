...
<div class="col-md-3 col-sm-12">
        ...
        <div class="row">
          <div class="col-md-5 col-sm-12">
            ...
            :          
            <select class="form-control form-select-lg mb-2 select2" aria-label="Default select example" name="bairro2" id="bairro2">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <input class="w3-input w3-border form-control " value="'.date('Y-m-d').'" type="date"  name="agendado"  name="agendado" id="agendado"required>
          </div>
          <div class="col-md-3 col-sm-12">
